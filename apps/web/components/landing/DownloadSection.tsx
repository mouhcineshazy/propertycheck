      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Start documenting your rental property today. Take timestamped photos,
            generate professional reports, and protect your damage deposit.
          </p>
          ...
          >
            <div className="flex flex-col items-center gap-2 p-4">
              ...
              <p className="text-sm text-gray-600 text-center">Get started in minutes with our easy-to-use app</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-4">
              ...
              <p className="text-sm text-gray-600 text-center">Capture and organize photos with automatic timestamps</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-4">
              ...
              <p className="text-sm text-gray-600 text-center">Generate professional inspection reports instantly</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
